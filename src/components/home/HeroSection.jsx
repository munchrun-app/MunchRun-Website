...
function HeroSection () {
  ...
  return (
    <section className='hero min-h-[85vh] bg-base-200 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-base-100 z-10' />
      <div
      ...
      <div className='absolute -bottom-8 left-0 right-0 h-16 bg-gradient-to-t from-base-100 to-transparent z-30' />
    </section>
  )
}
