                      ...
                      <div className="card-body p-4">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="w-full bg-base-300 rounded-full h-2.5">
                            <div className="bg-success h-2.5 rounded-full" style={{width: `${fees.munchRun.breakdown.restaurantPercent}%`}}></div>
                          </div>
                        ...
                        <div className="mb-3">
                          ...
                          <div className="w-full bg-base-300 rounded-full h-2.5">
                            <div className="bg-info h-2.5 rounded-full" style={{width: `${fees.munchRun.breakdown.driverPercent}%`}}></div>
                          </div>
                        ...
                        <div>
                          ...
                          <div className="w-full bg-base-300 rounded-full h-2.5">
                            <div className="bg-primary h-2.5 rounded-full" style={{width: `${fees.munchRun.breakdown.platformPercent}%`}}></div>
                          </div>
                    ...
                    <div className="card bg-base-200">
                      <div className="card-body p-4">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="w-full bg-base-300 rounded-full h-2.5">
                            <div className="bg-success h-2.5 rounded-full" style={{width: `${fees.other.breakdown.restaurantPercent}%`}}></div>
                          </div>
                        ...
                        <div className="mb-3">
                          ...
                          <div className="w-full bg-base-300 rounded-full h-2.5">
                            <div className="bg-info h-2.5 rounded-full" style={{width: `${fees.other.breakdown.driverPercent}%`}}></div>
                          </div>
                        ...
                        <div>
                          ...
                          <div className="w-full bg-base-300 rounded-full h-2.5">
                            <div className="bg-error h-2.5 rounded-full" style={{width: `${fees.other.breakdown.platformPercent}%`}}></div>
                          </div>
